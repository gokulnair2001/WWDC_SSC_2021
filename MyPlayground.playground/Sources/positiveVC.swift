...
public class positiveVC: UIViewController {
    ...
    public override func viewDidLoad() {
        ...
        subLabel.text = "You are expected to be COVID Positive.\n Do visit a doctor as soon as possible to stop the spread among others!"
        subLabel.numberOfLines = .max
        subLabel.textAlignment = .center
        subLabel.font = UIFont(name: "Avenir Medium", size: 16)
        view.backgroundColor = UIColor.white
        
        closeBtn.setTitle("Sure", for: .normal)
